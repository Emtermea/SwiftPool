...
/// Limit the number of results returned. The default is <code>5</code> for forward geocoding and <code>1</code> for reverse geocoding.
...
@interface MBPlacemark : NSObject <NSSecureCoding>
...
/// A geocoder object that allows you to query the <a href="https://www.mapbox.com/api-documentation/?language=Swift#geocoding">Mapbox Geocoding API</a> for known places corresponding to a given location. The query may take the form of a geographic coordinate or a human-readable string.
...
- (NSURLSessionDataTask * _Nonnull)geocodeWithOptions:(MBGeocodeOptions * _Nonnull)options completionHandler:(void (^ _Nonnull)(NSArray<MBGeocodedPlacemark *> * _Nullable, NSString * _Nullable, NSError * _Nullable))completionHandler SWIFT_WARN_UNUSED_RESULT;
...
/// \param location An array of up to 50 <code>CLLocation</code> objects to search for.
///
